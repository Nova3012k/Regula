...
public class ClaseAction extends Agent {
    ...
    protected class Genetico extends OneShotBehaviour {
        ...
        public void action() {
            ...
            for (int generacion = 1; generacion <= generaciones; generacion++) {
                System.out.println("Poblacion " + generacion);
            ...
            System.out.println();
            System.out.println("B0: " + coeficientes[0]);
            System.out.println("B1: " + coeficientes[1]);
            System.out.println();
    ...
    protected class Predicciones extends CyclicBehaviour{
        ...
        public void action() {
            ...
            System.out.println("    Y = " + coeficientes[0] + " + " + coeficientes[1] + " ( " + inicio + " ) = " + formato.format(pronostico));
            inicio++;
        }
    }
